            ...
            {open && (
              <div role="menu" style={{ position: "absolute", top: 48, right: 0, minWidth: 220, background: "var(--cream)", border: "2px solid var(--ink)", borderRadius: 14, boxShadow: "5px 5px 0 var(--ink)", padding: 12, zIndex: 50 }}>
                ...
                <button
                  ...
                  disabled={signingOut}
                  style={{ width: "100%", padding: "9px 14px", border: "1.5px solid var(--ink)", borderRadius: 999, background: "var(--moon)", color: "var(--ink)", fontWeight: 800, fontSize: 13, cursor: signingOut ? "wait" : "pointer", boxShadow: "2px 2px 0 var(--ink)" }}
                >
